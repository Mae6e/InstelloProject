...
const Modal = (props) => {
    ...
    return (
        <div id="story-modal" className="uk-modal-container uk-modal uk-open" uk-modal="" style={isShown?{ display: "block" }:{display: "none"}}>
            <div className="uk-modal-dialog story-modal">
                ...
                onClick={onCloseHandler} type="button" uk-close=""><svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg" data-svg="close-icon"><line fill="none" stroke="#000" strokeWidth="1.1" x1="1" y1="1" x2="13" y2="13"></line><line fill="none" stroke="#000" strokeWidth="1.1" x1="13" y1="1" x2="1" y2="13"></line></svg></button>

                <div className="story-modal-media">
                    <img src="https://i.ibb.co/PT7zGST/avatar-2.jpg" loading="lazy" width={100} height={100} alt="" className="inset-0 h-full w-full object-cover" />
                </div>
                        ...
                        <div className="flex flex-1 items-center space-x-4">
                            <a href="#">
                                <div className="bg-gradient-to-tr from-yellow-600 to-pink-600 p-0.5 rounded-full">
                                    <img src="https://i.ibb.co/PT7zGST/avatar-2.jpg" loading="lazy" className="bg-gray-200 border border-white rounded-full w-8 h-8" />
                                </div>
                            </a>
                        ...
                        <div className="simplebar-content" style={{ padding: "16px", height: "100%", overflow: "hidden" }} >
                            ...
                            <div className="py-4 ">
                                <div className="flex justify-around">
                                    ...
                                    <a href="#" className="flex items-center space-x-3">
                                        <div className="flex font-bold items-baseline"><i className="uil-comment"></i> {resources.EXPLORE.COMMENT}</div>
                                    </a>
                                    <a href="#" className="flex items-center space-x-3">
                                ...
                                <div className="flex items-center space-x-3">
                                    <div className="flex items-center">
                                        <img src="https://i.ibb.co/PT7zGST/avatar-1.jpg" loading="lazy" alt="" className="w-6 h-6 rounded-full border-2 border-white" />
                                        <img src="https://i.ibb.co/PT7zGST/avatar-4.jpg" loading="lazy" alt="" className="w-6 h-6 rounded-full border-2 border-white -mr-2" />
                                        <img src="https://i.ibb.co/PT7zGST/avatar-2.jpg" loading="lazy" alt="" className="w-6 h-6 rounded-full border-2 border-white -mr-2" />
                                    </div>
                                    <div>
                                        {resources.EXPLORE.LIKE} <strong> Johnson</strong> and <strong> 209 Others </strong>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="-mt-1 space-y-1">
                                <div className="flex flex-1 items-center space-x-2">
                                    <img src="https://i.ibb.co/PT7zGST/avatar-2.jpg" loading="lazy" className="rounded-full w-8 h-8" />
                                ...
                                <div className="flex flex-1 items-center space-x-2">
                                    <img src="https://i.ibb.co/PT7zGST/avatar-4.jpg" loading="lazy" className="rounded-full w-8 h-8" />
                                    <div className="flex-1 p-2">
